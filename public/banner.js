  ...
  function initExitIntent() {
    ...
    function showExitModal() {
      ...
      overlay.innerHTML = [
        ...
        '  <h2>Here\'s what your business gets with SubHub.</h2>',
        '  <ul style="text-align:left;list-style:none;padding:0;margin:0 0 20px;font-size:.9rem;color:#444;line-height:1.7">',
        '    <li>&#9989;&nbsp; Send quotes in minutes &mdash; not days</li>',
        '    <li>&#9989;&nbsp; Track every job from signed contract to final payment</li>',
        '    <li>&#9989;&nbsp; Offer financing &amp; get paid faster</li>',
        '    <li>&#9989;&nbsp; One login for your whole team</li>',
        '  </ul>',
        '  <a href="' + demoLink('exit-intent-benefits') + '" class="sch-cta-btn" target="_blank" rel="noopener">See It in 30 Minutes &#8594;</a>',
        '  <p class="sch-micro">Free demo &middot; No commitment &middot; Takes 2 min to book.</p>',
        '  <button class="sch-no-thanks">No thanks</button>',
        '</div>',
      ].join('');
